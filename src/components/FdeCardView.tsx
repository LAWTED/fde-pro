...
/**
 * 1:1 of the reference `lawted-sticker` demo from the holographic-sticker repo.
 * Nothing changed except the name pulls from card.name. Base photo, Stanford
 * watermark/logo, lawted signature, copyright, and the two SVG filters are all
 * verbatim from the original demo.
 */
export default function FdeCardView({ card }: { card: FdeCard }) {
  return (
    <HolographicSticker.Root>
      <HolographicSticker.Scene>
        ...
        <HolographicSticker.Card>
          ...
          <HolographicSticker.Watermark imageUrl="/ha7ch-tile.svg" opacity={1}>
            <HolographicSticker.Refraction intensity={1} />
